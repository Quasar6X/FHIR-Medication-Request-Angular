...
import { RouterModule, NavigationEnd, ActivatedRoute } from '@angular/router';
...
describe('TitleService', () => {
  ...
  it('should getTitle to be correct', () => {
    ...
    expect(mockTest.getTitle(state, (parent) as unknown as ActivatedRoute)).toEqual([testValue]);
  });
});
